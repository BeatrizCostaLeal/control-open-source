...
INSERT INTO apl_acesso.tab_empresa (cpf_cnpj, nome_fantasia, sobrenome_social, email, dt_aniversario, rg_ie, end_cep, end_logradouro, end_numero, end_complemento, end_referencia, end_telefone, end_bairro, end_estado, end_cidade, end_uf, end_ibge, tel_celular, tel_celular_whatsapp, tel_fixo, organizacao_id, ativ_com_prof, is_incompleto) VALUES('00000000000', 'EMPRESA SISTEMA', 'EMPRESA SISTEMA', 'sistema@digytal.com.br', '2023-09-23', '123', '64000020', 'AVENIDA FREI SERAFIM', '123', 'LADO IMPAR', '', NULL, 'CENTRO', 'PIAUI', 'TERESINA', 'PI', 2211001, 99999999999, false, NULL, 1, '', false);
