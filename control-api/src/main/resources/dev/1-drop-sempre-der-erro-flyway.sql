-- SE PRECISAR MUDAR A DDL DO BANCO
...
--CARGAS ADICIONAIS DE EXEMPLO
INSERT INTO apl_cadastro.tab_marca (nome, localiza, nome_abreviado, sigla, is_excluido, organizacao_id) VALUES('Apple', 'APPLE', 'Apple', 'APPLE', false, 1);
INSERT INTO apl_cadastro.tab_modelo (nome, localiza, nome_abreviado, sigla, is_excluido, organizacao_id) VALUES('iPhone 14', 'IPHONE 14', 'iPhone 14', 'IPH14', false, 1);
INSERT INTO apl_cadastro.tab_categoria (nome, localiza, nome_abreviado, sigla, is_excluido, organizacao_id) VALUES('Celulares e Smartphones', 'CELULARES E SMARTPHONES', 'Cel e Smartphones', 'CELSRT', false, 1);
